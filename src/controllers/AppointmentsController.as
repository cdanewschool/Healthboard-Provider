package controllers
{
	...
	public class AppointmentsController
	{
		...
		public function AppointmentsController( enforcer:SingletonEnforcer )
		{
		...
		public static function getInstance():AppointmentsController
		{
			if( !__instance ) __instance = new AppointmentsController( new SingletonEnforcer() );
